...
data[data["precon"] == "bddc"][["time_bpcg"]].unstack(level=0).transpose().plot.bar(subplots=True, figsize=(25, 10), layout=(1, 4), stacked=True)  # .unstack(level=1).plot.bar(subplots=True, figsize=(25, 10),layout=(1,6))
plt.show()

data[data["precon"] == "bddc"][["nits_minres", "nits_bpcg"]].unstack(level=0).transpose().plot.bar(subplots=True, figsize=(25, 10), layout=(1, 4), stacked=True)  # .unstack(level=1).plot.bar(subplots=True, figsize=(25, 10),layout=(1,6))
plt.show()
