...
def spaces_test(V, Q, order, precon="bddc",block=True):
	results = {}
	alpha = 10
...
res = spaces_test(V, Q, 2, precon="multi")
...
for a in range(4):
	...
	for e in element_names:
		...
		for order in [1, 2]:
			...
			data = data.append(
				{"method": e + str(order), "ndofs": V.ndof + Q.ndof, "precon": "bddc", "vert": mesh.nv, **result},
				ignore_index=True)
