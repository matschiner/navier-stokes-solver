...
def bramble_pasciak_cg(a_matrix, b_matrix, c_matrix, pre_a, pre_schur_complement, \
    ...
    if current_residual_error_squared == 0:
        return solution

    for iteration in range(max_steps):
        iteration_timer = Timer("Bramble Pasciak CG Iteration " + str(iteration))
        ...
        alpha = previous_residual_error_squared / InnerProduct(full_preconditioned_residuum, temp_1)
